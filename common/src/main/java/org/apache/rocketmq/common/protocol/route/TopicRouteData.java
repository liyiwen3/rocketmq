...
public class TopicRouteData extends RemotingSerializable {
    private String orderTopicConf;//顺序top的配置 格式为: {brokerName}:{queueCount};{brokerName}:{queueCount}...
    ...
    public TopicRouteData cloneTopicRouteData() {
        ...
        if (this.queueDatas != null) {
            topicRouteData.getQueueDatas().addAll(this.queueDatas);//这个地方是要加判空，不然报空指针
        }
