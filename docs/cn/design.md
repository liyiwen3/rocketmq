...
flag | int | flag的第一个位 0表示Request， 1表示是response， 第二个位0表示是rpc， 1为oneway | flag的第一个位 0表示Request， 1表示是response， 第二个位0表示是rpc， 1为oneway
remark | String | 传输自定义文本信息 | 传输自定义文本信息
extFields | HashMap<String, String> | 请求自定义扩展信息 | 响应自定义扩展信息
serializeTypeCurrentRPC | SerializeType | 请求序列化方式 | 响应序列化方式
