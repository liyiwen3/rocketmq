...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    private void checkConfig() throws MQClientException {
        ...
        // consumeConcurrentlyMaxSpan offset的最大宽度默认是2000
        ...
        // pullThresholdForQueue 队列缓存消息的最大值 默认是1000
        ...
        // pullThresholdForTopic topic级别缓存消息的最大值 默认是-1， 即不限制
        ...
        // pullThresholdSizeForQueue 队列缓存消息的最大存储量 默认为100m
        ...
        if (this.defaultMQPushConsumer.getPullThresholdSizeForTopic() != -1) {
            // pullThresholdSizeForTopic topic级别缓存消息的最大存储量 默认为-1, 即不限制
        ...
        // consumeMessageBatchMaxSize 批量消费消息的最大值 默认为1
