...
public class ClientConfig {
    ...
    /**
     * Pulling topic information interval from the named server 从nameserver获取topic信息的时间间隔
     */
    private int pollNameServerInterval = 1000 * 30;
    /**
     * Heartbeat interval in microseconds with message broker 30s 和broker的心跳间隔
     */
    ...
    public void changeInstanceNameToPID() {
        if (this.instanceName.equals("DEFAULT")) {//实例名如果是DEFAULT，则将实例名改成pid
